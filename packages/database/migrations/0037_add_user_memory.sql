CREATE TABLE IF NOT EXISTS "user_memories" (
	...
	"title" varchar(255),
	"summary" text,
	"summary_vector_1024" bytea,
	"details" text,
	"details_vector_1024" bytea,
	"status" varchar(255),
...
CREATE TABLE IF NOT EXISTS "user_memories_experiences" (
	...
	"type" varchar(255),
	"situation" text,
	"situation_vector" bytea,
	"reasoning" text,
	"possible_outcome" text,
	"action" text,
	"action_vector" bytea,
	"key_learning" text,
	"key_learning_vector" bytea,
	"metadata" jsonb,
...
CREATE TABLE IF NOT EXISTS "user_memories_preferences" (
	...
	"conclusion_directives_vector" bytea,
	"type" varchar(255),
	"suggestions" text,
...
--CREATE INDEX "user_memories_summary_vector_1024_index" ON "user_memories" USING btree ("summary_vector_1024" vector_cosine_ops);--> statement-breakpoint
--CREATE INDEX "user_memories_details_vector_1024_index" ON "user_memories" USING btree ("details_vector_1024" vector_cosine_ops);--> statement-breakpoint
--CREATE INDEX "user_memories_contexts_title_vector_index" ON "user_memories_contexts" USING btree ("title_vector" vector_cosine_ops);--> statement-breakpoint
--CREATE INDEX "user_memories_contexts_description_vector_index" ON "user_memories_contexts" USING btree ("description_vector" vector_cosine_ops);--> statement-breakpoint
--CREATE INDEX "user_memories_contexts_type_index" ON "user_memories_contexts" USING btree ("type");--> statement-breakpoint
--CREATE INDEX "user_memories_experiences_situation_vector_index" ON "user_memories_experiences" USING btree ("situation_vector" vector_cosine_ops);--> statement-breakpoint
--CREATE INDEX "user_memories_experiences_action_vector_index" ON "user_memories_experiences" USING btree ("action_vector" vector_cosine_ops);--> statement-breakpoint
--CREATE INDEX "user_memories_experiences_key_learning_vector_index" ON "user_memories_experiences" USING btree ("key_learning_vector" vector_cosine_ops);--> statement-breakpoint
--CREATE INDEX "user_memories_experiences_type_index" ON "user_memories_experiences" USING btree ("type");--> statement-breakpoint
--CREATE INDEX "user_memories_identities_description_vector_index" ON "user_memories_identities" USING btree ("description_vector" vector_cosine_ops);--> statement-breakpoint
--CREATE INDEX "user_memories_identities_type_index" ON "user_memories_identities" USING btree ("type");--> statement-breakpoint
--CREATE INDEX "user_memories_preferences_conclusion_directives_vector_index" ON "user_memories_preferences" USING btree ("conclusion_directives_vector" vector_cosine_ops);
